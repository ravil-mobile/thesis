...
% unequal length of \gls{mpi} messages 
...
\begin{minipage}{\linewidth}
\begin{lstlisting}[language=python, caption={Pseudocode of the default \gls{athlet}-\gls{nut} coupling: \gls{nut} part}, frame=single, label={lst:athlet-grs-defaul:nut}]
# N - problem size
