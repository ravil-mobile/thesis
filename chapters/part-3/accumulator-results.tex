...
It turned out that \textit{BM2} benchmark was slower than the default \gls{athlet} approach in  approximately \textbf{2\%} in case of the inter-node communication. However, non-blocking data broadcast, according to \textit{BM1} benchmark, helped to alleviate the slow-down and achieve almost \textbf{3\%} of improvement.\\
