...
Detailed descriptions of all tuning parameters listed in table \ref{table:preconditioners} can be found in either \acrshort{petsc} or Hypre user’s manuals, \cite{balay2018petsc} and \cite{falgout2010hypre}, respectively.\\
