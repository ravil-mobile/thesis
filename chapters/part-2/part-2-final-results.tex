...
Figures \ref{fig:mumps-final-comparison-1} and \ref{fig:mumps-final-comparison-2} show comparisons of \gls{mumps} parallel performance before and after application of the optimal \gls{mumps} settings, found in subsections \ref{subseq:fill-in-reordering}, \ref{subseq:mm-mumps-process-pinning}, \ref{subseq:blas-comparison}, and \ref{subseq:mpi-openmp}, to \gls{grs} matrix set. Results labeled as \textit{default} were obtained using the fill reducing reordering algorithm provided by ParMetis library because it had been used by \gls{athlet} users before the current study.\\
...
\centering
	...
	\end{tabular}
	\caption{Comparisons of parallel factorizations of small- and middle-sized \gls{grs} matrices between applications of the default and optimal MUMPS configurations}
...
\centering
	...
	\end{tabular}
	\caption{Comparisons of parallel factorizations of large-sized \gls{grs} matrices between applications of the default and optimal MUMPS configurations}
