...
\centering
	...
	\end{tabular}
	\caption{Anomalies of parallel execution of \gls{mumps}-OpenBLAS configuration during factorizations of large-sized \gls{grs} matrices running \ with 2 \gls{openmp} threads per \gls{mpi} process}
...
\caption{Thread conflicts of \gls{mumps}-OpenBLAS configuration detected during \textit{k3-18} matrix parallel factorization (green - application threads, red - system threads)}
...
\end{tabular}
\caption{Compassions of different hybrid \gls{mpi}/\gls{openmp} modes used for parallel factorization of \gls{grs} matrix set on \gls{hw1}}
...
\end{tabular}
\caption{Compassions of different hybrid \gls{mpi}/\gls{openmp} modes used for parallel factorization of \gls{grs} matrix set on \gls{hw2}}
...
\end{tabular}
\caption{Compassions of different hybrid \gls{mpi}/\gls{openmp} modes used for parallel factorization of SuiteSparse matrix set on \gls{hw1}}
...
\end{tabular}
\caption{Compassions of different hybrid \gls{mpi}/\gls{openmp} modes used for parallel factorization of SuiteSparse matrix set on \gls{hw2}\\}
