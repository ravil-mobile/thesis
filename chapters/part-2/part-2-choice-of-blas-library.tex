...
Among all libraries listed in table \ref{table:list-of-blas-implementations} there were only three available on HW1 machine, namely: Netlib BLAS, Intel MKL and OpenBLAS. Thus, 3 versions of MUMPS-PETSc libraries were compiled and tested with using GRS matrix set.\\
